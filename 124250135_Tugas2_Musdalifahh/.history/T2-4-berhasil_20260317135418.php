...
<body class="">
  ...
  <div class="latar">
    <div class="isiberhasil d-flex justify-content-center align-items-center">
      <!-- form -->
      <form action="T2-5-invoice.php" class="berhasil" method="post">
        ...
        <input type="hidden" name="jumlahtiket" value="<?= $_POST["jumlahtiket"] ?>">
        <input type="hidden" name="pilihkursi" value="<?= $_POST["pilihkursi"] ?>">
        <input type="hidden" name="pilihbayar" value="<?= $_POST["pilihbayar"] ?>">
